...
from app.api.dependencies import check_auth, get_patient_service
...
async def create_patient(
    ...
    """
    db_patient = service.create(patient)
    return JSONResponse(
        status_code=201,
...
async def get_patient(
    ...
    """
    db_patient = service.get_by_id(patient_id)
...
async def update_patient(
    ...
    """
    db_patient = service.update(patient_id, patient)
    return db_patient.resource_json
